...
\begin{figure}[!b]
 \vspace{-20pt}
  ...
  \includegraphics[trim=80 100 80 80,clip,width=0.9\linewidth]{Figures/slic_cropped2}\\
  \caption{SLIC superpixels on LAB color space.Each of the superpixels are colored with the mean L, a and b values of that particular superpixel. The leaf boundaries obtained by integrating the superpixels having the leaf pigments are shown in green dots.}\label{fig:slic_cropped2}
\end{figure}
